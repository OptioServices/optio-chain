...
const (
	Query_Params_FullMethodName   = "/optio.rewardtoken.Query/Params"
	Query_Denom_FullMethodName    = "/optio.rewardtoken.Query/Denom"
	Query_DenomAll_FullMethodName = "/optio.rewardtoken.Query/DenomAll"
)
