...
var fileDescriptor_472b40e3c09e071b = []byte{
	...
	0x1c, 0x88, 0x94, 0x52, 0x1c, 0x17, 0x9b, 0x7f, 0x69, 0x49, 0x41, 0x69, 0x89, 0x90, 0x11, 0x17,
	0x7b, 0x62, 0x4a, 0x4a, 0x51, 0x6a, 0x71, 0xb1, 0x04, 0xa3, 0x02, 0xa3, 0x06, 0xa7, 0x93, 0xc4,
	0xa5, 0x2d, 0xba, 0x22, 0x50, 0xc5, 0x8e, 0x10, 0x99, 0xe0, 0x92, 0xa2, 0xcc, 0xbc, 0xf4, 0x20,
	0x98, 0x42, 0x21, 0x31, 0x2e, 0xb6, 0xc4, 0xdc, 0xfc, 0xd2, 0xbc, 0x12, 0x09, 0x26, 0x05, 0x46,
	0x0d, 0x96, 0x20, 0x28, 0xcf, 0x8a, 0xa3, 0x63, 0x81, 0x3c, 0xc3, 0x8b, 0x05, 0xf2, 0x0c, 0x4e,
	...
	0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0xef, 0x0f, 0xf2, 0x5e, 0x70, 0x6a, 0x51, 0x59, 0x66,
	0x72, 0x6a, 0xb1, 0x3e, 0xd8, 0xb3, 0xba, 0xc9, 0x19, 0x89, 0x99, 0x79, 0xfa, 0x15, 0xc8, 0x9e,
	0x2e, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0xbb, 0xdc, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff,
	0x16, 0x17, 0x57, 0xbc, 0x73, 0x01, 0x00, 0x00,
}
...
func (m *Output) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Amount != 0 {
		i = encodeVarintDistribute(dAtA, i, uint64(m.Amount))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Address) > 0 {
...
func (m *Output) Size() (n int) {
	...
	if m.Amount != 0 {
		n += 1 + sovDistribute(uint64(m.Amount))
	}
	return n
}
