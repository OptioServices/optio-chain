...
func (m *MsgDistribute) GetAmount() types.Coin {
	if m != nil {
		return m.Amount
	}
	return types.Coin{}
...
func (m *MsgDistribute) GetRecipients() []*MsgDistribute_Output {
	if m != nil {
		return m.Recipients
	}
	return nil
...
func (m *MsgDistribute_Output) Reset()         { *m = MsgDistribute_Output{} }
func (m *MsgDistribute_Output) String() string { return proto.CompactTextString(m) }
func (*MsgDistribute_Output) ProtoMessage()    {}
func (*MsgDistribute_Output) Descriptor() ([]byte, []int) {
	return fileDescriptor_f171c6c2c94eb3af, []int{2, 0}
}
func (m *MsgDistribute_Output) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgDistribute_Output) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgDistribute_Output.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgDistribute_Output) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgDistribute_Output.Merge(m, src)
}
func (m *MsgDistribute_Output) XXX_Size() int {
	return m.Size()
}
func (m *MsgDistribute_Output) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgDistribute_Output.DiscardUnknown(m)
}

var xxx_messageInfo_MsgDistribute_Output proto.InternalMessageInfo

func (m *MsgDistribute_Output) GetAmount() uint64 {
	if m != nil {
		return m.Amount
	}
	return 0
...
func (m *MsgDistribute_Output) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MsgDistribute_Output)(nil), "optio.distribute.MsgDistribute.Output")
...
var fileDescriptor_f171c6c2c94eb3af = []byte{
	...
	,
}
...
func (m *MsgDistribute_Output) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgDistribute_Output) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgDistribute_Output) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgDistribute_Output) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgDistribute) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.Recipients = append(m.Recipients, &MsgDistribute_Output{})
...
func (m *MsgDistribute_Output) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
