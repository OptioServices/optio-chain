...
import (
	...
	"optio/testutil/sample"
	rewardtokensimulation "optio/x/rewardtoken/simulation"
	"optio/x/rewardtoken/types"
)

// avoid unused import issue
var (
	_ = rewardtokensimulation.FindAccount
	_ = rand.Rand{}
	_ = sample.AccAddress
	_ = sdk.AccAddress{}
...
func (AppModule) GenerateGenesisState(simState *module.SimulationState) {
	...
	rewardtokenGenesis := types.GenesisState{
	...
	simState.GenState[types.ModuleName] = simState.Cdc.MustMarshalJSON(&rewardtokenGenesis)
}
...
func (am AppModule) WeightedOperations(simState module.SimulationState) []simtypes.WeightedOperation {
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		rewardtokensimulation.SimulateMsgCreateDenom(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		rewardtokensimulation.SimulateMsgUpdateDenom(am.accountKeeper, am.bankKeeper, am.keeper),
	))
	...
	operations = append(operations, simulation.NewWeightedOperation(
		...
		rewardtokensimulation.SimulateMsgDeleteDenom(am.accountKeeper, am.bankKeeper, am.keeper),
	))
